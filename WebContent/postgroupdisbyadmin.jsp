...
<div class="container">
		<div class="row">
				...
				<form action="PostGroupDisAdminController" method="post">
						<label for="validationDefault01" style="padding:0.5rem;">Group Discussion Question</label> <input
								type="text" class="form-control" id="validationDefault01"
								placeholder="Group Discussion Question" value="" name="question" required>
						<div>	
						<button class="btn btn-lg btn-primary btn-lg" type="submit"	value="submit" style="margin:1rem">Post</button>
						</div>
					</form>
				</div>
		</div>
