	...
	<nav class="navbar navbar-expand-lg navbar-light bg-danger ">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto" id="navId">
				...
				<li class="nav-item active bg-danger"><a class="nav-link" href="UserDisplayAdminController" style="color:white">GetAllUser<span class="sr-only">(current)</span></a></li>
	...
	<div class="container">
		<div class="row">
			<div class="col-sm p-5">
				<h2 class="form-signin-heading">User Registration Form For Admin</h2>

				<br>
				<form action="RegisterUserAdmin" method="post">
					<div class="form-row">
						...
						<div class=col-md-12>
							<span>Email: </span> <label for="inputEmail" class="sr-only">Email
								...
								placeholder="Email address" value="" name="emailAddress"
								...
								placeholder="Mobile" value="" name="mobileNumber" required>

							<br> <span>Password: </span> <label for="inputPassword"
								class="sr-only">Password</label> <input type="password"
								id="inputPassword" class="form-control" placeholder="Password"
								value="" name="password" required> <br> <span>User
								Type: </span> <label for="inputPassword" class="sr-only">User
								Type</label> <input type="password" id="UserType" class="form-control"
								placeholder="User Type" value="" name="userType" required></input>
							<br>
						</div>
