...
<nav class="navbar navbar-expand-lg navbar-light bg-danger ">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			...
			<li class="nav-item active bg-danger"><a class="nav-link" href="DisplayDiscussionController" style="color:white">GetAllDiscussion<span class="sr-only">(current)</span></a></li>
...
<div class="container">
		<div class="row" style="padding-top:5rem">
				<div class="col-md-12 card"  style="padding:2rem;padding-left:1rem;">
				<form action="DeleteAnsAdminController" method="post">
						<div>	
						<button class="btn btn-block btn-danger btn-lg" type="submit"	value="submit" style="margin:1rem">DeleteAllAnswer</button>
						</div>
					</form>
				</div>
		</div>
