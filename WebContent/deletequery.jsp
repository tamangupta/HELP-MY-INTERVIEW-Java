...
<nav class="navbar navbar-expand-lg navbar-dark bg-danger">
		...
		<div class="collapse navbar-collapse" id="navbarSupportedContent">
			<ul class="navbar-nav mr-auto" id="navId">
				...
				<li class="nav-item active bg-danger"><a class="nav-link" href="DisplayQueryController" style="color:white">AllQueries<span class="sr-only">(current)</span></a></li>
...
<div class="container">
		<div class="row">
				...
				<form action="DeleteQueryController" method="post">
						<label for="validationDefault01" style="padding:0.5rem;">Enter Email Id Of Query User</label> <input
								type="text" class="form-control" id="validationDefault01"
								placeholder="Enter Email Id Of User" value="" name="emailAddress" required>
						<div>	
